...
public class Main {
    public static void main(String args[]) {
        ...
        System.out.println("Current quiz total score and average score for stud2: " + stud2.getTotalScore() + " " + stud2.getAverageScore());
        System.out.println();
        System.out.println("Setting 20% (0.2) for quiz contribution");
        Student.setQuizContribution(0.2);
        System.out.println("Quiz marks (Out of 20 marks): " + stud2.getQuizFinalScore());
    }
}
